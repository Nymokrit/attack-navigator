# FORKED
The app has been forked to be deployed as a QRadar App in a custom QRadar Tab.

Minor changes have been performed to the code in order to be able to store and read custom layers on the QRadar server.
